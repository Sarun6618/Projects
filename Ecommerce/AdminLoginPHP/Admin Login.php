...
<body>
    ...
    if(isset($_POST['Login']))
    {
        ...
        #escaping special symbols used in sel statements
        ...
        if($stmt=mysqli_prepare($con,$query))
        {
            ...
            mysqli_stmt_store_result($stmt);//tranfering the result of exection in $stmt
        ...
        {
            echo"<script>alert('SQL Query cannot be prepared');
            </script>";
        }
    }?>
</body>
